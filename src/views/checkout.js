                                ...
                                <Box>
                                    <h2>
                                        ...
                                        <FormControl my="5">
                                            ...
                                            <Input type="text" name="fullname" my="1" fontSize="14px" borderRadius="0" placeholder="Enter your full name"
                                            />
                                        </FormControl>
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px" >Email address:</FormLabel>
                                            <Input type="text" name="email" my="1" fontSize="14px" borderRadius="0" placeholder="Enter your email address" />
                                        </FormControl>
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px" >Company (optional):</FormLabel>
                                            <Input type="text" name="company" my="1" fontSize="14px" borderRadius="0" placeholder="Enter your company" />
                                        </FormControl>
                                    </h2>
                                </Box>
                                ...
                                <Box my="4">
                                    <h2>
                                        ...
                                        <FormControl my="5">
                                            ...
                                            <Input type="text" name="address" my="1" fontSize="14px" borderRadius="0" placeholder="Enter your shipping address" />
                                        </FormControl>
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px" >Address:</FormLabel>
                                            <Input type="text" name="state" my="1" fontSize="14px" borderRadius="0" placeholder="Enter your address" />
                                        </FormControl>
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="0px" left="17px" >Country:</FormLabel>
                                            <Select onChange={(e) => setCountryCode(e.target.value)} fontSize="14px" borderRadius="0" placeholder="Enter your country">
                                                {
                                        ...
                                        <FormControl my="5">
                                            ...
                                            <Input type="tel" name="phone" my="1" fontSize="14px" borderRadius="0" placeholder="Enter your phone number" />
                                        </FormControl>
                                    </h2>
                                </Box>
                            </Box>
                ...
                <Box w={["100%", "100%", "36%"]} border="1px solid #f4f4f4" fontSize="14px" p="20px" mx={[0, 0, "2%"]} >
                    <Box>
                        <FormControl my="5">
                            ...
                            <Input type="text" name="cardName" borderRadius="0" placeholder="Enter the name on card" />
                        </FormControl>
                        <FormControl my="5">
                            <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px" >Card number:</FormLabel>
                            <Input type="text" name="CardNumber" borderRadius="0"  placeholder="Enter the card number"/>
                        </FormControl>
                        ...
                        <Flex my="5" justify="space-between">
                            <FormControl w="70%">
                                ...
                                <Input type="text" name="expiry" my="0" me="1" borderRadius="0" placeholder="Enter the card expiry date" />
                            </FormControl>
                            <FormControl w="25%">
                                <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px" >CVV:</FormLabel>
                                <Input type="text" name="cvv" borderRadius="0"  placeholder="Enter CVV"/>
                            </FormControl>
                        </Flex>
